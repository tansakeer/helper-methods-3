...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { bio: @actor.bio, dob: @actor.dob, name: @actor.name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { bio: @actor.bio, dob: @actor.dob, name: @actor.name } }
